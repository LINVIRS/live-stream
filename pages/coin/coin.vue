<template>
	<view class="border-top border-light-secondary p-3">
		...
		<view class="position-fixed left-0 bottom-0 right-0 border-top flex px-3 align-center"
		style="height: 100rpx;">
		<view class="flex align-center">
			<text class="iconfont text-warning mr-1">&#xe633;</text>
		...
		<uni-popup ref="popup" type="dialog">
			...
			inputType='number' :before-close="true" @close="close" @confirm="confirm"></uni-popup-dialog>
			</uni-popup>
	</view>
</template>
...
<script>
	...
	data() {
	  ...
	  onLoad(){
		  let p =this.lsit[this.activeIndex].price
		  if(p>0){
			  this.price=p
		  }
	  },
