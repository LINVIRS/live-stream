                  ...
                  _c(
                    ...
                    [
                      _c("u-image", {
                        ...
                        staticStyle: { height: "120rpx", width: "120rpx" },
                        attrs: {
                          src: _vm.form.cover || "../../static/banner/1.jpg"
                        }
                      }),
                      _c(
                        "u-text",
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _uniPopup = _interopRequireDefault(__webpack_require__(/*! ../../components/uni-ui/uni-popup/uni-popup.vue */ 27));\nvar _request = _interopRequireDefault(__webpack_require__(/*! ../../common/request.js */ 45));\nvar _config = _interopRequireDefault(__webpack_require__(/*! ../../common/config.js */ 44));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { components: { uniPopup: _uniPopup.default }, data: function data() {return { // 直播服务器地址，暂时为空\n      url: '', // 标清模式\n      mode: 'SD', // 是否启用摄像头\n      enableCamera: true, // 默认摄像头\n      position: 'back', // 美颜程度\n      beauty: 0, //美白度\n      whitness: 0, // 窗体高度\n      windowHeight: 0, context: null, statusBarHeight: 0, modeList: [{ type: 'SD', desc: '标清' }, { type: 'HD', desc: '高清' }, { type: 'FHD', desc: '超清' }], popupType: 'mode', form: { title: '', cover: '' } };}, // 监听页面加载，其参数为上个页面传递的数据，参数类型为Object（用于页面传参）\n  onLoad: function onLoad() {var res = uni.getSystemInfoSync();this.windowHeight = res.windowHeight;this.statusBarHeight = res.statusBarHeight;__f__(\"log\", '状态栏的高度是' + res.statusBarHeight, \" at pages/create-live/create-live.nvue:184\");}, // 监听页面初次渲染完成，如果渲染速度快，会在页面进入动画完成前触发\n  onReady: function onReady() {this.context = uni.createLivePusherContext('livePusher', this);this.startPreview();}, computed: { popupTitle: function popupTitle() {var o = { mode: '画质', beauty: '美颜', whiteness: '美白' };return o[this.popupType];} }, methods: { chooseCover: function chooseCover() {var _this = this;uni.chooseImage({ count: 1, success: function success(res) {_request.default.upload('/upload', { filePath: res.tempFilePaths[0] }, function (p) {__f__(\"log\", p, \" at pages/create-live/create-live.nvue:212\");}).then(function (res) {_this.form.cover = _config.default.imgUrl + res.url;});} });}, // 进入直播间\n    openLiveRoom: function openLiveRoom() {var _this2 = this;_request.default.post('/live/create', this.form, { token: true }).then(function (res) {var options = { mode: _this2.mode, position: _this2.position, beauty: _this2.beauty, whiteness: _this2.whitness };uni.navigateTo({ url: \"../live-room/live-room?options=\".concat(JSON.stringify(options), \"&data=\").concat(encodeURIComponent(JSON.stringify(res))) });});}, handleSliderChange: function handleSliderChange(e) {this[this.popupType] = e.detail.value;}, // 画质选择\n    chooseMode: function chooseMode(item) {this.mode = item.type;uni.showToast({ title: '画质切换为' + item.desc, icon: 'none' });this.$refs.popup.close();}, openPopup: function openPopup(type) {this.popupType = type;this.$refs.popup.open();}, // \t切换摄像头\n    switchCamera: function switchCamera() {var _this3 = this;this.context.switchCamera({ success: function success(e) {_this3.position = _this3.position === 'back' ? 'front' : 'back';} });}, // 开启预览模式\n    startPreview: function startPreview() {this.context.startPreview({ success: function success(e) {__f__(\"log\", e, \" at pages/create-live/create-live.nvue:266\");} });}, // 直播状态的变化\n    statechange: function statechange(e) {__f__(\"log\", e, \" at pages/create-live/create-live.nvue:272\");}, // 直播网络的变化\n    netstatus: function netstatus(e) {__f__(\"log\", e, \" at pages/create-live/create-live.nvue:276\");}, // 直播出错\n    error: function error(e) {__f__(\"log\", e, \" at pages/create-live/create-live.nvue:280\");} } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 9)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///54\n");
